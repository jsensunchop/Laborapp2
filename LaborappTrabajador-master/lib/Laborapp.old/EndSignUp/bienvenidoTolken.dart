...
class _main2State extends State<main2> {
  ...
  void continueWorkerRute(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (context) => main4()));
  }
  ...
  void _showToast(BuildContext context) {
    Fluttertoast.showToast(
        msg: "Con el ID va a poder usar las\n"
            "funciones que se implementarán\n"
            "proximamente dentro de la aplicación",
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text(
                                "Este es su usuario y código dentro de la aplicación",
                                style: TextStyle(
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text(
                                "Ya sólo falta que seleccione su\n "
                                "  ubicación y sus habilidades\n"
