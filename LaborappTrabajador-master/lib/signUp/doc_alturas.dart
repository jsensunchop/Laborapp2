...
class doc_alturas extends StatefulWidget {
  @override
  _doc_alturasState createState() => _doc_alturasState();
}

class _doc_alturasState extends State<doc_alturas> {
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text("CERTIFICADO DEL CURSO DE ALTURAS",
                                style: TextStyle(
                                    fontSize: 12, fontFamily: "Poppins-Medium"))
                          ],
                        ),
